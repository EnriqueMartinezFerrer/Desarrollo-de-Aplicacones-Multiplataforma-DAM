...
public class in {
  ...
  public static BigInteger leerBigInteger(String mensaje) {
  ...
  public static BigInteger leerBigInteger() {
  ...
  public static BigInteger leerBigInteger(String mensaje, Predicate<BigInteger> v, String... error) {
    BigInteger valor = new BigInteger("0");
    while (!v.test(valor = leerBigInteger(mensaje))) {
      if (error.length > 0) {
        System.out.print(error[0]);
        continue;
      } 
  ...
  public static BigDecimal leerBigDecimal(String mensaje, Predicate<BigDecimal> v, String... error) {
    BigDecimal valor = new BigDecimal("0");
    while (!v.test(valor = leerBigDecimal(mensaje))) {
      if (error.length > 0) {
        System.out.print(error[0]);
        continue;
      } 
